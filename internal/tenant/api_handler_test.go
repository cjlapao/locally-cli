...
func (m *MockTenantService) GetTenantByID(ctx *appctx.AppContext, idOrSlug string) (*models.Tenant, *diagnostics.Diagnostics) {
...
func (m *MockTenantService) CreateTenant(ctx *appctx.AppContext, tenant *models.Tenant) (*models.Tenant, *diagnostics.Diagnostics) {
...
func (m *MockTenantService) UpdateTenant(ctx *appctx.AppContext, tenantRequest *TenantUpdateRequest) (*models.Tenant, *diagnostics.Diagnostics) {
...
func TestRoutes(t *testing.T) {
	...
	for i, expected := range expectedRoutes {
		...
		assert.True(t, routes[i].AuthRequired)
	}
}
