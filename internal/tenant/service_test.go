...
func setupTenantServiceWithMock(mockStore *MockTenantDataStore) TenantServiceInterface {
...
func TestGetTenantByID(t *testing.T) {
	...
	result, diag := service.GetTenantByID(ctx, tenantID)
...
func TestUpdateTenant(t *testing.T) {
	...
	ctx := appctx.NewContext(nil)
	updateRequest := &TenantUpdateRequest{
		ID:           "tenant1",
		Name:         "Updated Tenant",
