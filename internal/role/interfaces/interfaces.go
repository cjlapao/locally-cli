...
type RoleServiceInterface interface {
	...
	GetRolesByFilter(ctx *appctx.AppContext, tenantID string, filter *filters.Filter) (*api.PaginatedResponse[pkg_models.Role], *diagnostics.Diagnostics)
	...
	GetRoleUsers(ctx *appctx.AppContext, tenantID string, id string, pagination *pkg_models.Pagination) (*api.PaginatedResponse[pkg_models.User], *diagnostics.Diagnostics)
	...
	GetPaginatedRoleClaims(ctx *appctx.AppContext, tenantID string, roleID string, pagination *pkg_models.Pagination) (*api.PaginatedResponse[pkg_models.Claim], *diagnostics.Diagnostics)
