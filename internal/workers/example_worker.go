...
func (w *EmailWorker) Process(ctx context.Context, message *WorkerMessage) error {
	// Parse the payload
...
func (w *NotificationWorker) Process(ctx context.Context, message *WorkerMessage) error {
	// Parse the payload
