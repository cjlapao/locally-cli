...
func TestDiagnostics_Append(t *testing.T) {
	parent := New("parent-operation")
	child := New("child-operation")
...
func TestDiagnostics_MultipleAppends(t *testing.T) {
	parent := New("parent-operation")
	child1 := New("child1-operation")
	child2 := New("child2-operation")
