...
func TestSecurityLevel_GetParent(t *testing.T) {
	tests := []struct {
		...
		{"Guest parent is User", SecurityLevelGuest, SecurityLevelUser},
...
func TestSecurityLevel_GetChildren(t *testing.T) {
	tests := []struct {
		...
		{"User children", SecurityLevelUser, []SecurityLevel{SecurityLevelGuest}},
...
func TestSecurityLevel_GetAllChildren(t *testing.T) {
	tests := []struct {
		...
		{"SuperUser all children", SecurityLevelSuperUser, []SecurityLevel{SecurityLevelAdmin, SecurityLevelManager, SecurityLevelUser, SecurityLevelGuest, SecurityLevelNone}},
		{"Admin all children", SecurityLevelAdmin, []SecurityLevel{SecurityLevelManager, SecurityLevelUser, SecurityLevelGuest, SecurityLevelNone}},
		{"Manager all children", SecurityLevelManager, []SecurityLevel{SecurityLevelUser, SecurityLevelGuest, SecurityLevelNone}},
		{"User all children", SecurityLevelUser, []SecurityLevel{SecurityLevelGuest, SecurityLevelNone}},
...
func TestSecurityLevel_IsEqual(t *testing.T) {
	tests := []struct {
		...
		{"User not equals Guest", SecurityLevelUser, SecurityLevelGuest, false},
...
func TestSecurityLevel_GetLevel(t *testing.T) {
	tests := []struct {
		...
		{"Guest level", SecurityLevelGuest, 4},
		{"None level", SecurityLevelNone, 5},
	}
