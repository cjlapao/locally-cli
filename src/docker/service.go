...
func (svc *DockerService) RunEfMigrations(context, baseImage, imageName, repoUrl, projectPath,
	startupProjectPath string, dbConnectionString string, arguments, environmentVars map[string]string) error {
...
func (svc *DockerService) generateEfMigrationDockerFile(baseImage, imageName, repoUrl, projectPath,
	startupProjectPath string, dbConnectionString string, arguments []string, environmentVars map[string]string) string {
