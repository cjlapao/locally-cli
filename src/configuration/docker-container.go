...
type DockerContainer struct {
	...
	Repository           *GitCloneRepository    `json:"repository,omitempty" yaml:"repository,omitempty"`
...
func (task *DockerContainer) BuildDependency() error {
	err := BuildDependencyGraph(task.Components, false)
	return err
}
